 ...
 * @author Laucha
 */
public class viewAgregarMaterias extends javax.swing.JInternalFrame {
    private HashSet<Materia> setmat;
    /**
     * Creates new form viewAgregarMaterias
     */
    public viewAgregarMaterias(HashSet<Materia> m) {
        initComponents();
        setmat=m;
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jtfAnio, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jbtGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtGuardarActionPerformed
        ...
        Integer an = Integer.parseInt(jtfAnio.getText());
        
        Materia m = new Materia(id,nom,an);
        
        if (setmat.add(m)){
            JOptionPane.showMessageDialog(this, "Materia agregada con exito.");
        } else {
            JOptionPane.showMessageDialog(this, "Ya existe una materia con esa id.");
        }
        
        } catch (NumberFormatException nfe) {
            JOptionPane.showMessageDialog(this, "ID o año no valido.");
        }
        jtfNombre.setText("");
        jtfId.setText("");
        jtfAnio.setText("");
